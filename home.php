...
<html lang="pt">
    ...
    <body>
        ...
        <header class="container header">
            ...
            <div class="row ">
                <div class="col-auto teste mx-auto">
                    <a class="header-link active" href="home.php">Home</a>
        ...
        <main class="container">
            ...
            <div class="row">
                <div class="col-12 home-main d-flex align-items-center justify-content-center">
