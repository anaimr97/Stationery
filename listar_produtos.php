<?php
    ...
    $form = isset($_GET["tipo"]) && isset($_GET["ordem"]);

    if($form){

        if(!empty($_GET["tipo"]) && !empty($_GET["ordem"])){

            if((($_GET["tipo"] == "id") || ($_GET["tipo"] == "nome") || ($_GET["tipo"] == "preco") || ($_GET["tipo"] == "quantidade")) && (($_GET["ordem"] == "ASC") || ($_GET["ordem"] == "DESC"))){

                $tipo = $_GET["tipo"];
                $ordem = $_GET["ordem"];

                $produtos = selectSQL("SELECT * FROM produtos ORDER BY $tipo $_GET[ordem]");
            }
        ...
        <header class="container header">
            ...
            <div class="row ">
                <div class="col-auto mx-auto">
                    ...
                    <a class="header-link active" href="listar_produtos.php">Listar Produtos</a>
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <form action="" method="get" class="form-listar">
                        ...
                        <select name="tipo">
                            <option <?= ($tipo == "id") ? "selected" : ""; ?> value="id">ID</option>
                            <option <?= ($tipo == "nome") ? "selected" : ""; ?> value="nome">Nome</option>
                            <option <?= ($tipo == "preco") ? "selected" : ""; ?> value="preco">Preço</option>
                            <option <?= ($tipo == "quantidade") ? "selected" : ""; ?> value="quantidade">Quantidade</option>
                        </select>

                        <input <?= ($ordem == "ASC") ? "checked" : ""; ?> type="radio" name="ordem" value="ASC">
                        <label for="ascendente">Ascendente</label>

                        <input <?= ($ordem == "DESC") ? "checked" : ""; ?> type="radio" name="ordem" value="DESC">
                        <label for="descendente">Descendente</label>

                        <input class="botao" type="submit" value="Listar">
